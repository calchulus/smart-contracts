...
contract HeroNames is SafeMath, Ownable {
    
    mapping (address => uint256) registrants;
    
    
    function() public payable {
        becomeRegistrant(msg.sender, msg.value);
    }

    /*
     * Receives a donation in ETH
     */
    function becomeRegistrant(address buyer, uint256 amountInWei) internal {
        
        registrants[msg.sender] = safeAdd(registrants[msg.sender], amountInWei);
    }
